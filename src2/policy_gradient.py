...
class PolicyGradient(object):
    ...
    def __init__(self, env, config, seed, logger=None):
        ...
        # self.obserfvation_dim = self.env.get_observation_space_n()
        # self.action_dim = (
    ...
    def sample_path(self, env, num_episodes=None):
        ...
        while num_episodes or t < self.config.batch_size:
            ...
            for step in range(self.config.max_ep_len):
                ...
                states.append(state)
                # pdb.set_trace()
                # print("OUR player hand: ", env.player_hands[env.current_player])
                ...
                # if done:
                #     print(f"{env.current_player} won the game!")
                #     state = env.reset()
                # print(rewards)
    ...
    def get_returns(self, paths):
        ...
        for path in paths:
            ...
            discounts = np.array([self.config.gamma ** i for i in range(timesteps)])
            
            returns = []
            for t in range(timesteps):
                returns.append(np.dot(rewards[t:], discounts[:timesteps - t]))
            #######################################################
            #########          END YOUR CODE.          ############
    ...
    def update_policy(self, observations, actions, advantages):
        ...
        loss = -1/actions.shape[0] * torch.dot(distribution.log_prob(actions), advantages)
    ...
    def train(self):
        ...
        torch.save(self.policy.network.state_dict(), "baseline_rand.pth")
