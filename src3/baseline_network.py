...
class BaselineNetwork(nn.Module):
    ...
    def __init__(self, env, config):
        ...
        observation_dim = self.env.observation_space.n
    ...
    def forward(self, observations):
        ...
        # pdb.set_trace()
        output = self.network(observations.reshape(observations.shape[0], -1)).squeeze()
    ...
    def update_baseline(self, returns, observations):
        ...
        loss = nn.MSELoss()
        output = loss(returns, self.forward(observations))
